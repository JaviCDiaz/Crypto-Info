...
class CustomGrip(QWidget):
    def __init__(self, parent, position):
        ...
        self.grip_widgets = GripWidgets()

        # TOP LEFT GRIP
        if position == "top_left":
            self.grip_widgets.top_left(self)
            grip = QSizeGrip(self.grip_widgets.top_left_grip)
            grip.setFixedSize(self.grip_widgets.top_left_grip.size())
            self.setGeometry(5, 5, 15, 15)
            self.grip_widgets.top_left_grip.setStyleSheet("background: transparent")

        # TOP RIGHT GRIP
        if position == "top_right":
            self.grip_widgets.top_right(self)
            grip = QSizeGrip(self.grip_widgets.top_right_grip)
            grip.setFixedSize(self.grip_widgets.top_right_grip.size())
            self.setGeometry(self.parent.width() - 20, 5, 15, 15)
            self.grip_widgets.top_right_grip.setStyleSheet("background: transparent")

        # BOTTOM LEFT GRIP
        if position == "bottom_left":
            self.grip_widgets.bottom_left(self)
            grip = QSizeGrip(self.grip_widgets.bottom_left_grip)
            grip.setFixedSize(self.grip_widgets.bottom_left_grip.size())
            self.setGeometry(5, self.parent.height() - 20, 15, 15)
            self.grip_widgets.bottom_left_grip.setStyleSheet("background: transparent")

        # BOTTOM RIGHT GRIP
        if position == "bottom_right":
            self.grip_widgets.bottom_right(self)
            grip = QSizeGrip(self.grip_widgets.bottom_right_grip)
            grip.setFixedSize(self.grip_widgets.bottom_right_grip.size())
            self.setGeometry(self.parent.width() - 20, self.parent.height() - 20, 15, 15)
            self.grip_widgets.bottom_right_grip.setStyleSheet("background: transparent")

        # TOP GRIP
        if position == "top":
            self.grip_widgets.top(self)
            ...
            self.grip_widgets.top_grip.mouseMoveEvent = resize_top
            self.grip_widgets.top_grip.setStyleSheet("background: transparent")

        # BOTTOM GRIP
        elif position == "bottom":
            self.grip_widgets.bottom(self)
            ...
            self.grip_widgets.bottom_grip.mouseMoveEvent = resize_bottom
            self.grip_widgets.bottom_grip.setStyleSheet("background: transparent")

        # LEFT GRIP
        elif position == "left":
            self.grip_widgets.left(self)
            ...
            self.grip_widgets.left_grip.mouseMoveEvent = resize_left
            self.grip_widgets.left_grip.setStyleSheet("background: transparent")

        # RIGHT GRIP
        elif position == "right":
            self.grip_widgets.right(self)
            ...
            self.grip_widgets.right_grip.mouseMoveEvent = resize_right
            self.grip_widgets.right_grip.setStyleSheet("background: transparent")
    ...
    def resizeEvent(self, event):
        if hasattr(self.grip_widgets, 'top_grip'):
            self.grip_widgets.top_grip.setGeometry(0, 0, self.width(), 10)

        elif hasattr(self.grip_widgets, 'bottom_grip'):
            self.grip_widgets.bottom_grip.setGeometry(0, 0, self.width(), 10)

        elif hasattr(self.grip_widgets, 'left_grip'):
            self.grip_widgets.left_grip.setGeometry(0, 0, 10, self.height() - 20)

        elif hasattr(self.grip_widgets, 'right_grip'):
            self.grip_widgets.right_grip.setGeometry(0, 0, 10, self.height() - 20)

        elif hasattr(self.grip_widgets, 'top_right_grip'):
            self.grip_widgets.top_right_grip.setGeometry(self.width() - 15, 0, 15, 15)

        elif hasattr(self.grip_widgets, 'bottom_left_grip'):
            self.grip_widgets.bottom_left_grip.setGeometry(0, self.height() - 15, 15, 15)

        elif hasattr(self.grip_widgets, 'bottom_right_grip'):
            self.grip_widgets.bottom_right_grip.setGeometry(self.width() - 15, self.height() - 15, 15, 15)


class GripWidgets(object):
